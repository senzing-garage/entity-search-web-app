...
- `webServerHostName` - the internally resolveable hostname of the webapp. default is to try to automagically figure this out from the `$SENZING_WEB_SERVER_URL` value but sometimes there can be a need to explicitly define this value.
